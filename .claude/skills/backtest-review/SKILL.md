...
> **Adaptation projet (ganesh_trading)** — Contexte actions US (QQQ/SPY), pas crypto : remplacer « perps/funding » par frais + slippage de `config.yaml`, et « BTC » par SPY. Régimes à tester séparément : 2018 (Q4), 2020 (COVID), 2022 (baissier), 2023-2024 (haussier). Chaque point de la checklist est consigné OK / KO / non applicable dans `docs/AUDIT.md` (Phase 3) ; les KO se corrigent avant tout passage sur l'OOS.
