...
> **Adaptation projet (ganesh_trading)** — Bêta et corrélation vs **SPY** (pas BTC). Entrée : les rendus journaliers du backtest VectorBT (`outputs/`) ; sortie : tableau dans `docs/AUDIT.md`. `periods_per_year=252` en daily.
