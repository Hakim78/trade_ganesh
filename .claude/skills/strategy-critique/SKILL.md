...
> **Adaptation projet (ganesh_trading)** — Contexte : QQQ/SPY en paper trading Alpaca, aucune position réelle. Chocs historiques à considérer : février-mars 2020, 2022, août 2024, avril 2025 (plutôt que LUNA/FTX). Le résultat (rating + 3 questions) est consigné dans `docs/AUDIT.md`.
